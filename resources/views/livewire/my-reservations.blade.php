        ...
        @if ($reservations->count() > 0)
            ...
            <div class="mt-12 bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-600">{{ $reservations->where('status', 'confirmed')->count() }}</div>
                        <div class="text-gray-600">Confirmed</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-red-600">{{ $reservations->where('status', 'cancelled')->count() }}</div>
        ...
        @else
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="text-center py-16 px-8">
                    ...
                    <p class="text-xl text-gray-600 mb-8">Ready to experience culinary excellence? Make your first reservation today!</p>
                    <a href="/reservation" 
